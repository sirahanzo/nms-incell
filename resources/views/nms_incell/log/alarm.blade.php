        ...
        <div class="tab-content">
            ...
            @for ($i = 1; $i <= 15; $i++)
                <div class="tab-pane fade {{ ($i ==1)?'active in':''  }}" id="nav-tab2-{{$i}}">
                    ...
                    @include('nms_incell.log._table_event_pack',['pack_id' => $i])
...
@section('js')
    ...
    <script>
        ...
        let url_log_data_show="{{ route('log-event-show') }}";
        let url_log_data_pack ="{{ route('log-event-pack') }}";
        let url_log_data_pack_periode ="{{ route('log-event-pack-periode') }}";
        let url_log_data_download ="{{ route('log-event-download') }}"
