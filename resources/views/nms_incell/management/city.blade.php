                ...
                <div class="panel-body" id="monitoring_site">
                    <form class="form-horizontal form-bordered" id="newRegionForm" style="display: none">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select name="region_oid" id="region_oid" class=" selectpicker form-control">
                                    <option value=""> -- Select Regions --</option>
                                    @foreach($regions as $region)
                                        <option value="{{ $region->oid }}">{{ $region->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select name="icon" id="icon" class=" selectpicker form-control">
                                    ...
                                    <option data-icon="fa fa-building fa-lg" value="fa fa-building fa-lg">Building (Default)</option>
...
@section('js')
    ...
    <script>
        ...
        var url_manufature_show = "{{ route('city-list') }}";
        ...
        function edit(id) {
            ...
            $.get("{{ url('city-edit') .'/' }}" + id, function (data) {
