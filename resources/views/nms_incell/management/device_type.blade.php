            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" id="monitoring_site">
                    <form class="form-horizontal form-bordered" id="newRegionForm" style="display: none">
                        ...
                        {{--                       @endif--}}
                        <div class="form-group">
                            <label class="col-md-3 control-label">TYPE OF DEVICE NAME</label>
                            <div class="col-md-6">
...
@section('js')
    ...
    <script>
        ...
        var url_manufature_show = "{{ route('device-type-list') }}";
        ...
        function edit(id) {
            ...
            $.get("{{ url('device-type-edit') .'/' }}" + id, function (data) {
        ...
        $('#store').click(function (e) {
            ...
            var url = "{{ route('device-type-create') }}";
            var formData = $('#newRegionForm').serialize();
        ...
        function deleteData(id) {
            swal({
                ...
                function () {
                    ...
                    $.ajax({
                        url: "{{ url('device-type-destroy').'/' }}" + id,
                        type: "DELETE",
                        data: {_token: _token},
                        //if success
                        success: function () {
